...
<script>
	$(function() {
		...
		$("#updateBtn").on("click", function() {
			...
			//여기까지 진행되면 validation 통과 --> sunmit
// 			concole.log($("#frm").serialize());
			$("#frm").submit();
		});
	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
				...
				<form id="frm" action="/studentUpdate" class="form-horizontal"
					role="form" method="post" enctype="multipart/form-data">

					<div class="form-group">
						<label for="id" class="col-sm-2 control-label">프로필</label>
						<div class="col-sm-10">
							<img src="/pic?id=${studentVo.id}" width="150">
					...
					<div class="form-group">
						...
						<div class="col-sm-2">
							<input type="text" class="form-control" id="id" name="id"
								value="${studentVo.id }" placeholder="학생 아이디">
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<label id="addr1lable" class="control-label">${studentVo.addr1 }</label>
							<input id="addr1Input" type="hidden" name="addr1"
								value="${studentVo.addr1 }">
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							...
							<input id="zipcdInput" type="hidden" name="zipcd"
