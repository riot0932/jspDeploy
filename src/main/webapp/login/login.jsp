...
<script>
	...
	function setCookie(cookieName, cookieValue, expires) {
		...
		document.cookie = cookieName + "=" + cookieValue + "; path=/; expries="
				+ dt.toGMTString();
	...
	$(function() {
		if (getCookie("rememberMe") == "y") {
			//userId input userId cookie 값을 설정
...
// 				userId = userId == null ? "" : userId;
		%>
		<input type="text"id="userId" name="userId" class="form-control"placeholder="Email address"
		 required autofocus value="${param.userId}"> 
		<label for="password" class="sr-only">Password</label> 
		<input type="password" id="password" name="password" class="form-control" placeholder="Password" required>

		<div class="checkbox">
			<label> <input type="checkbox" id="rememberMe"
				name="rememberMe" value="remember-me"> Remember me
			</label>
		</div>
